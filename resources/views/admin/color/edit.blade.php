                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('color.update',$color->id) }}" method="post">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name" value="{{ $color->name }}" id="firstName" class="form-control" placeholder="Unit Name" />
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="color" name="code" value="{{ $color->code }}" id="firstName" class="form-control" placeholder="Unit Code" />
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Color Description">{{ $color->description }}</textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <label for="email" class="col-md-3 form-label">Published Status</label>
                            <div class="col-md-9 pt-3">
                                <label class=""><input type="radio" name="status" value="1" {{ $color->status == 1 ? 'checked' : '' }}><span class="text-13">Published</span></label>
                                <label class=""><input type="radio" name="status" value="0" {{ $color->status == 0 ? 'checked' : '' }}><span class="text-13">Unpublished</span></label>
                            </div>
                        </div>
