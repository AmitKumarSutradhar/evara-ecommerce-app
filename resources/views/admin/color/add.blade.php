                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('color.store') }}" method="post">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="name" value="{{ old('name') }}" id="firstName" class="form-control" placeholder="Color Name" />
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input type="color" name="code" value="{{ old('code') }}" id="firstName" class="form-control" placeholder="Color Code" />
